...
.style50 {color: #6600FF; font-weight: bold; font-size: 18px; font-family: Verdana, Arial, Helvetica, sans-serif; }
...
<body onload="bodyLoad()">
  ...
  <table width="948" border="2">
    <tr>
      <th scope="col"><span class="style36">Booking Seats for 40 Seater Bus </span></th>
    </tr>
  </table>
  <p>&nbsp;</p>
