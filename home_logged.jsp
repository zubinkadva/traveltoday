...
.style63 {font-size: 18px; font-family: "Times New Roman", Times, serif; }
...
<span class="style39">Online Bus Booking and much more !&nbsp;&nbsp; </span>
 ...
 <tr>
	...
	<table width="99%"   border="0" cellpadding="0" cellspacing="0" id="navigation">
        <tr>
  ...
  &nbsp;
	  ...
	  <table width="595" border="0">
        <tr>
          <th width="589" scope="col"><span class="style63">Check Out Our Latest Offer </span></th>
        </tr>
        <tr>
          <th scope="row"><span class="style64"></span></th>
        </tr>
        <tr>
          <th scope="row"><span class="style63">Click On the Image below To Learn More </span></th>
        </tr>
        <tr>
          <th scope="row">&nbsp;</th>
        </tr>
        <tr>
          <th scope="row"><a href="#"><img src="img/special-offer.gif" width="149" height="125" border="0" onclick="modal_Offers()"/></a></th>
        </tr>
      </table>
	  <p class="style40">
	  <%String type1=(String)session.getAttribute("TheAccountType");
	  if(type1.equals("admin")) {%>
	  </p>
	  <table width="282" border="0">
        <tr>
          <td width="272"><p class="style40"> <span class="style65">Administrator Priveleges</span></p></td>
        </tr>
        <tr>
          <td><a href="admin_page.jsp" class="style13">Edit / View Buses</a></td>
        </tr>
        <tr>
          <td class="style13"><a href="admin_cancel.jsp">View Cancelled Tickets</a> </td>
        </tr>
      </table>
	  <p class="style40">
	    <%}%>	  
